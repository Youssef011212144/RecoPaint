    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        ...
        <div class="row tm-mb-90 tm-gallery">
        	...
        	<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                ...
                <img height="400px" width="400px" src="/producforselltimage/{{ $product->img }}" alt="Image" class="img-fluid img-thumbnail" onclick="openModal('{{ $product->img }}', event)">
...
<div class="row tm-mb-90">
    ...
    function openModal(imageSrc, event) {
        ...
        modalImg.src = "/producforselltimage/" + imageSrc; // Set the image in the modal
    }
